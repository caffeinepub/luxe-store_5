...
function HeroSection() {
  ...
  const [shopBtnMag, setShopBtnMag] = reactExports.useState({ x: 0, y: 0 });
  const [exploreBtnMag, setExploreBtnMag] = reactExports.useState({ x: 0, y: 0 });
  const [heroGlitch, setHeroGlitch] = reactExports.useState(false);
  const shopBtnRef = reactExports.useRef(null);
  const exploreBtnRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    let timeoutId;
    const schedule = () => {
  ...
  const handleMagneticMove = reactExports.useCallback(
    (e, setMag, ref) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              ...
              top: "30%",
              left: "25%",
              background: "radial-gradient(ellipse, rgba(0,255,255,0.25) 0%, rgba(255,0,255,0.08) 50%, transparent 70%)",
              animationDelay: "-9s",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              ...
              top: "10%",
              left: "45%",
              background: "radial-gradient(ellipse, rgba(57,255,20,0.18) 0%, transparent 60%)",
              animationDelay: "-3s",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              ...
              height: 400,
              borderRadius: "50%",
              background: "radial-gradient(circle, rgba(0,255,255,0.06) 0%, rgba(255,0,255,0.04) 40%, transparent 70%)",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "h1",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "DISCOVER".split("").map((char) => {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "PREMIUM".split("").map((char) => {
                        const delay = charIdx++ * 0.03;
                        const key = `p-${charIdx}`;
                        return /* @__PURE__ */ jsxRuntimeExports.jsx(
                          motion.span,
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "PRODUCTS".split("").map((char) => {
                        const delay = charIdx++ * 0.03;
                  ...
                  motion.div,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/products", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        ...
                        {
                          ref: shopBtnRef,
                          onMouseMove: (e) => handleMagneticMove(e, setShopBtnMag, shopBtnRef),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/about", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        ...
                        {
                          ref: exploreBtnRef,
                          onMouseMove: (e) => handleMagneticMove(e, setExploreBtnMag, exploreBtnRef),
