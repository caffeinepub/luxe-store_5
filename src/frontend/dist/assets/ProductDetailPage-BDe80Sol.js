import { C as useParams, w as useCart, x as useWishlist, j as reactExports, q as jsxRuntimeExports, L as Link, t as motion, D as Minus, P as Plus, S as ShoppingCart, H as Heart, A as AnimatePresence } from "./index-KWc8MtR0.js";
import { S as Skeleton, P as ProductCard } from "./ProductCard-BZ93TQX3.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-B4FaoVcW.js";
import { a as useProduct, b as useProductReviews } from "./useQueries-CSS84JfN.js";
import { m as mockProducts, g as getProductImage, S as Star } from "./mockData-6hh-iowj.js";
import { u as useInView, Z as Zap } from "./use-in-view-BWRw3TnC.js";
import "./index-g57z0Bmp.js";
function ProductDetailPage() {
  ...
  const [selectedImg, setSelectedImg] = reactExports.useState(0);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: productRef, className: "grid lg:grid-cols-2 gap-12 mb-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3", children: [0, 1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => setSelectedImg(i),
              className: `w-20 h-20 rounded-xl overflow-hidden border-2 transition-all ${selectedImg === i ? "border-luxe-cyan" : "border-border/50"}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          ...
          product.colors.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground mb-3 uppercase tracking-widest", children: "Color" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3", children: product.colors.map((color) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `w-8 h-8 rounded-full border-2 transition-all ${selectedColor === color ? "border-luxe-cyan scale-110" : "border-border/50"}`,
