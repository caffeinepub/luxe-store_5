    ...
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 relative z-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3", children: trending.map((product, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            TrendingCard,
            {
              product,
              index: i,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 w-[72px] h-[72px] rounded-lg overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              ...
              style: {
                background: "linear-gradient(135deg, rgba(0,204,204,0.18) 0%, rgba(168,85,247,0.18) 100%)",
                color: "#00cccc",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm leading-snug line-clamp-1 text-foreground", children: product.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-black", style: { color: "#00cccc" }, children: [
            "$",
            product.price.toFixed(2)
          ] }),
          product.originalPrice > product.price && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground line-through ml-1.5", children: [
            "$",
            ...
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full overflow-hidden border border-luxe-cyan/30 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                      src: t.avatar,
                      alt: t.name,
