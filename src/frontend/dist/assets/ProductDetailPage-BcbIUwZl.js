import { E as useParams, w as useCart, x as useWishlist, j as reactExports, F as getProductColorGallery, G as getProductImageForColor, q as jsxRuntimeExports, L as Link, A as AnimatePresence, t as motion, I as Minus, P as Plus, S as ShoppingCart, H as Heart } from "./index-VzrNFl3C.js";
...
import { P as ProductCard } from "./ProductCard-CuMBVSrp.js";
import { a as useProduct, b as useProductReviews, u as useAllProducts } from "./useQueries-CpDyxvt-.js";
import { S as Star } from "./star-Cloj6mtN.js";
import { u as useInView, Z as Zap } from "./use-in-view-B4eqJnNp.js";
...
function ProductDetailPage() {
  ...
  const relatedProducts = allProducts.filter((p) => p.category === (product == null ? void 0 : product.category) && p.id !== (product == null ? void 0 : product.id)).slice(0, 4);
