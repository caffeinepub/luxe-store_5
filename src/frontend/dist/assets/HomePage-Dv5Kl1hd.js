    ...
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 relative z-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5", children: trending.map((product, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            TrendingCard,
            {
              product,
              index: i,
...
function TrendingCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { aspectRatio: "3/4" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "absolute inset-0 pointer-events-none",
              style: {
                background: "linear-gradient(to top, rgba(0,0,0,0.88) 0%, rgba(0,0,0,0.45) 38%, transparent 70%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: { zIndex: 5 },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-cyan-300 font-semibold uppercase tracking-wider mb-1", children: product.category }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-white text-sm leading-snug line-clamp-2 mb-1", children: product.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-black text-cyan-300 text-base", children: [
                    "$",
                    product.price.toFixed(2)
                  ] }),
                  product.originalPrice > product.price && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-white/50 line-through", children: [
                    "$",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "trending-card-meta px-3 py-2.5 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold", style: { color: "#00ffff" }, children: [
            "$",
            product.price.toFixed(2)
          ] }),
