...
function HeroSection() {
  ...
  const spotlightRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    let timeoutId;
    const schedule = () => {
